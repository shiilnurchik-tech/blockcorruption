...
public class NormalAnimation implements PortalAnimationDriver {
    ...
    public static record Phase(
        ...
        public static Phase fromTag(CompoundTag tag) {
            long durationTicks = tag.getLongOr("durationTicks", 0);
            DeltaUnilateralPortalState delta = DeltaUnilateralPortalState.fromTag(tag.getCompoundOrEmpty("delta"));
            TimingFunction timingFunction = TimingFunction.fromString(tag.getStringOr("timingFunction", TimingFunction.linear.toString()));
    ...
    private static NormalAnimation deserialize(CompoundTag compoundTag) {
        ...
        long startingGameTime = compoundTag.getLongOr("startingGameTime", 0);
